...
const multer = require('multer') // позволяет работать с выгрузкой файлов
const path = require('path')
const fs = require('fs')
const Book = require('../models/book') // импортируем монgусс схему 
const uploadPath = path.join('public', Book.coverImageBasePath)
const Author = require('../models/author') // импортируем монgусс схему 
